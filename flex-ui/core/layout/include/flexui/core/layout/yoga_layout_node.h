/*
 * FlexUI modification notice:
 * Absorbed from Hippy dom/yoga_layout_node.h into FlexUI core/layout.
 * Changes: namespace hippy::dom -> flexui::core::layout;
 * HippyValue -> flexui::common::FlexUIValue; include paths updated.
...
class YogaLayoutNode : public LayoutNode, public std::enable_shared_from_this<YogaLayoutNode> {
 public:
  ...
  void SetLayoutStyles(
      const std::unordered_map<std::string, std::shared_ptr<flexui::common::FlexUIValue>>& style_update,
 ...
 private:
  void Parser(const std::unordered_map<std::string, std::shared_ptr<flexui::common::FlexUIValue>>& style_update,
              const std::vector<std::string>& style_delete);

  void SetYGWidth(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGHeight(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetDirection(YGDirection direction);

  void SetYGMaxWidth(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGMaxHeight(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGMinWidth(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGMinHeight(std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGFlexBasis(std::shared_ptr<flexui::common::FlexUIValue> dom_value);
  ...
  void SetYGPosition(YGEdge edge, std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGMargin(YGEdge edge, std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGPadding(YGEdge edge, std::shared_ptr<flexui::common::FlexUIValue> hippy_value);

  void SetYGBorder(YGEdge edge, std::shared_ptr<flexui::common::FlexUIValue> hippy_value);
