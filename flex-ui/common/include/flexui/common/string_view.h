 ...
 * modules/footstone/include/footstone/string_view.h in the Hippy project.
 *
...
template<>
struct std::hash<flexui::common::stringview::string_view::u8string> {
  std::size_t operator()(const flexui::common::stringview::string_view::u8string& value) const noexcept;
};
#endif
#endif

template<>
struct std::hash<flexui::common::stringview::string_view> {
  std::size_t operator()(const flexui::common::stringview::string_view& value) const noexcept;
};

inline namespace literals {
inline namespace string_literals {
[[nodiscard]] inline constexpr const flexui::common::stringview::string_view::char8_t_* operator "" _u8_ptr(
    const u8_type* u8, size_t) {
  return (flexui::common::stringview::string_view::char8_t_*) u8;
}

[[nodiscard]] inline const flexui::common::stringview::string_view operator "" _u8s(const u8_type* u8,
                                                                                       size_t length) {
  return flexui::common::stringview::string_view(u8, length);
}
