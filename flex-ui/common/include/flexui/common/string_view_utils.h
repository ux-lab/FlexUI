 ...
 * modules/footstone/include/footstone/string_view_utils.h in the Hippy project.
 *
...
class StringViewUtils {
 public:
  using string_view = flexui::common::string_view;
...
inline string_view operator+(const string_view &lhs,
  ...
  using SViewUtils = flexui::common::stringview::StringViewUtils;
  string_view::Encoding lhs_encoding = lhs.encoding();
  string_view::Encoding rhs_encoding = rhs.encoding();
  if (lhs_encoding <= rhs_encoding) {
    switch (rhs_encoding) {
      case string_view::Encoding::Latin1: {
        return string_view(
            SViewUtils::ConvertEncoding(lhs, rhs_encoding).latin1_value() +
                rhs.latin1_value());
      }
      case string_view::Encoding::Utf16: {
        return string_view(
            SViewUtils::ConvertEncoding(lhs, rhs_encoding).utf16_value() +
                rhs.utf16_value());
      }
      case string_view::Encoding::Utf32: {
        return string_view(
            SViewUtils::ConvertEncoding(lhs, rhs_encoding).utf32_value() +
                rhs.utf32_value());
      }
      case string_view::Encoding::Utf8: {
        return string_view(
            SViewUtils::ConvertEncoding(lhs, rhs_encoding).utf8_value() +
                rhs.utf8_value());
      }
      default: {
        FLEXUI_UNREACHABLE();
  ...
  switch (lhs_encoding) {
    case string_view::Encoding::Latin1: {
      return string_view(
          lhs.latin1_value() +
              SViewUtils::ConvertEncoding(rhs, lhs_encoding).latin1_value());
    }
    case string_view::Encoding::Utf16: {
      return string_view(
          lhs.utf16_value() +
              SViewUtils::ConvertEncoding(rhs, lhs_encoding).utf16_value());
    }
    case string_view::Encoding::Utf32: {
      return string_view(
          lhs.utf32_value() +
              SViewUtils::ConvertEncoding(rhs, lhs_encoding).utf32_value());
    }
    case string_view::Encoding::Utf8: {
      return string_view(
          lhs.utf8_value() +
              SViewUtils::ConvertEncoding(rhs, lhs_encoding).utf8_value());
    }
    default: {
      FLEXUI_UNREACHABLE();
    }
