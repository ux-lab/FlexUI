 ...
 * modules/footstone/include/footstone/persistent_object_map.h in the Hippy project.
 *
 * The FlexUI modifications:
 *   - Moved namespace `footstone::utils` -> `flexui::common`.
