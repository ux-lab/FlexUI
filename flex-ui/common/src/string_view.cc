...
// Task 7 will replace this bridge include with flexui/common/logging.h
...
std::size_t std::hash<flexui::common::stringview::string_view::u8string>::operator()(
  const flexui::common::stringview::string_view::u8string& value) const noexcept {
...
std::size_t std::hash<string_view>::operator()(
  const flexui::common::string_view& value) const noexcept {
  switch (value.encoding_) {
    case flexui::common::string_view::Encoding::Latin1:
      return std::hash<flexui::common::string_view::string>{}(value.latin1_string_);
    case flexui::common::string_view::Encoding::Utf8:
      return std::hash<flexui::common::string_view::u8string>{}(value.u8_string_);
    case flexui::common::string_view::Encoding::Utf16:
      return std::hash<flexui::common::string_view::u16string>{}(value.u16_string_);
    case flexui::common::string_view::Encoding::Utf32:
      return std::hash<flexui::common::string_view::u32string>{}(value.u32_string_);
    default:
      break;
  }
  return 0;
...
string_view::string& string_view::latin1_value() {
  FLEXUI_CHECK(encoding_ == Encoding::Latin1);
...
string_view::u8string& string_view::utf8_value() {
  FLEXUI_CHECK(encoding_ == Encoding::Utf8);
  return u8_string_;
}
...
string_view::u16string& string_view::utf16_value() {
  FLEXUI_CHECK(encoding_ == Encoding::Utf16);
  return u16_string_;
}
...
string_view::u32string& string_view::utf32_value() {
  FLEXUI_CHECK(encoding_ == Encoding::Utf32);
  return u32_string_;
}
