 ...
 * modules/footstone/src/repeating_timer.cc in the Hippy project.
 *
...
RepeatingTimer::RepeatingTimer(const std::shared_ptr<TaskRunner>& task_runner)
...
std::weak_ptr<BaseTimer> RepeatingTimer::GetWeakSelf() {
